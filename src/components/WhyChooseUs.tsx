...
export default function WhyChooseUs() {
  return (
    <section className="relative overflow-hidden px-5 py-28 md:px-8 md:py-40" id="why-us">
      <div className="absolute inset-x-0 top-0 h-28 mist-band mist-drift opacity-40" />
      <InkLandscape
        className="absolute -bottom-28 left-0 h-[34rem] w-full opacity-[0.06]"
        mirror
        reflection
        temple={false}
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl gap-20 lg:grid-cols-[0.82fr_1.18fr] lg:gap-28">
        ...
        >
          {teachings.map((teaching) => (
            <motion.li key={teaching.number} variants={itemVariants}>
              <div className="brush-divider mb-10" />
              <div className="grid gap-8 py-4 md:grid-cols-[5rem_1fr]">
                <span className="font-jp text-5xl text-seal/80">{teaching.number}</span>
                <div>
